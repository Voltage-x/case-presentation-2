...
def get_args():
    ...
    parser.add_argument('--train-raw', default='./src/preprocess/total_raw.pkl')
    parser.add_argument('--test-raw', default='./src/preprocess/test_raw.pkl')
    parser.add_argument('--brain-diff', default=0)
