...
predict_valid() {
    ...
    conf=./conf/${model}.py
    snapshot=./model/${model}_total/fold${fold}_ep${ep}.pt
    valid=./model/${model}_total/fold${fold}_ep${ep}_valid_tta${tta}.pkl
...
predict_test() {
    ...
    conf=./conf/${model}.py
    snapshot=./model/${model}_total/fold${fold}_ep${ep}.pt
    test=./model/${model}_total/fold${fold}_ep${ep}_test_tta${tta}.pkl
...
# predict_valid model100 8 3
# predict_valid model100 9 3
...
# predict_valid model110 8 3
# predict_valid model110 9 3
